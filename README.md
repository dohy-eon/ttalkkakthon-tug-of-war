...
모바일 기울기로 조작하는 실시간 웹 기반 줄?다리기? 게임
...
- 출시 우선 범위: **공통 기능 + 2인 모드 + 팀전**
- 확장 범위(후속): **SYNC 시스템, 명예/불명예 전당(사진 업로드)**
...
- 명예/불명예 전당 기록은 SQLite로 영속 저장됩니다.
- DB 파일 위치: `server/data/game-data.db`
